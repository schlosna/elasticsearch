...
public class ClusterDynamicSettingsModule extends AbstractModule {
    ...
    public ClusterDynamicSettingsModule() {
        ...
        clusterDynamicSettings.addDynamicSetting(HierarchyCircuitBreakerService.FIXEDBITSET_CIRCUIT_BREAKER_LIMIT_SETTING, Validator.MEMORY_SIZE);
        clusterDynamicSettings.addDynamicSetting(HierarchyCircuitBreakerService.FIXEDBITSET_CIRCUIT_BREAKER_OVERHEAD_SETTING, Validator.NON_NEGATIVE_DOUBLE);
